...
> [variant](../ai-context/glossary.md#variant) of an existing fact) and the one funnel every entrance feeds
...
This chapter covers the entrances themselves — what a [submitter](../ai-context/glossary.md#submitter) sees, what
