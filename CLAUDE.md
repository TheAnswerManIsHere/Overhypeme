...
4a. **A reply to an instruction opens by quoting the words it answers**, in a
   blockquote, never a paraphrase; a reply without it is malformed. Exempt: a
   bare choice. **Several asks in one message are named before any is answered.**
