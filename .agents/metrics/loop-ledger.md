...
resolve at all**: its review window opens at PR-open (2026-08-04T21:49:02Z)
and runs the ~1.1 hours row 22's `review hrs` column records — `20:14–21:49
UTC` is that row's separately-measured *pre-open preflight* interval (first
commit → PR open), not the review window — and even PR-open alone sits
roughly five to six days after the `-06:00` reading of the 2026-07-29
toggle, so it joins #288/#289 as the third confirmed
post-boundary point.
...
restatement: #308 is roughly five to six days later than #288/#289
(2026-08-04 vs. 2026-07-30, depending on which review timestamp is used)
and the first post-boundary point measured since. #294 ran a
