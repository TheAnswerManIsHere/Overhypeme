...
that reconciliation, not because a gate fired; see row 17's note), and
#298 (29.4% exact disagreement, also over the gate, also `unmeasured`;
see row 22's note). Naming
...
#298 would all qualify by round shape but are excluded because their
figures are `unmeasured`, not because they're single-round loops** — the
two exclusion reasons are different and shouldn't be conflated. (#294's
causal share is unresolved for a different reason than #290/#292/#298's
...
- **Round 1 is where new ground lives.** In #282, round 1 was 11/11 new
  ...
  than added to this confirmed count.)
- **Wrong fix dominates propagation in four of the seven loops, not all
  ...
  way #270/#289/#301 are. #301, though, **is** a clean confirmation of the
...
Four of this file's twenty-two rows (#276, #283, #292 — and #284 only narrowly escaping)
