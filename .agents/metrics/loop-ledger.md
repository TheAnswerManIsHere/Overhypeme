...
22's note), and #291 (28.1% exact disagreement, also over the gate, also
`unmeasured`; see row 23's note). Naming
...
engagement, because only round 1 produced findings. **#290, #291, #292,
#294, and #298 would all qualify by round shape but are excluded because
their figures are `unmeasured`, not because they're single-round loops** —
the two exclusion reasons are different and shouldn't be conflated. (#294's
causal share is unresolved for a different reason than #290/#291/#292/#298's
gate-tripping — see row 17's note — but the trend-exclusion result is the
same.)
...
- **Round 1 is where new ground lives.** In #282, round 1 was 11/11 new
  ...
  author classification separately shows 9/9 for its own round 1, and
  #298's and #291's both show a clean round 1 too — 5/5 and 4/4 — but with
  all three rows' overall causal share `unmeasured`, they're noted in rows
  17/22/23 rather than added to this confirmed count.)
- **Wrong fix dominates propagation in four of the seven loops, not all
  ...
  counted. #301, though, **is** a clean confirmation of the
...
Four of this file's twenty-three rows (#276, #283, #292 — and #284 only narrowly escaping)
