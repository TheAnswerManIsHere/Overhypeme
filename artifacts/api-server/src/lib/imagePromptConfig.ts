...
20. The concrete visual fields are REQUIRED and non-empty: coreScene (one tight paragraph), subjectDetails (≥1 concrete entry), environment (≥1 concrete entry). Make them dense — prefer specific, observable detail over generic phrasing.
