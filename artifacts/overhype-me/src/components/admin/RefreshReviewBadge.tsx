 ...
 * future renders; declining keeps the live fact exactly as it is today. This
 * is never a fact rejection — the fact already cleared triage and stays in
 * the database no matter what happens to the refresh candidate.
...
export function RefreshReviewBadge() {
  return (
    <span
      ...
      title="Versioned enrichment refresh of a live fact. Approving promotes the new enrichment for future renders; declining keeps the live fact exactly as it is — the fact is never rejected, only this update. Existing memes and images are never changed."
